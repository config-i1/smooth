...
def _calculate_initial_parameters_and_bounds(
    ...
    lags_dict = {
        ...
        "lags_model": model_params["lags_model"],
        "lags_model_max": model_params["lags_model_max"],
        #  'lags_model_seasonal': model_params.get('lags_model_seasonal') # Needs to be
        # passed correctly
    }
                ...
                if current_est_init_seas_val[i]:
                    try:
                        ...
                        if num_params_this_comp > 0:
                            ...
                            )  # check if est_init_seasonal_val implies multiple distinct seasonalities
                            names.extend(
                                [
                        ...
                        print(
                            f"Warning: Could not determine initial seasonal parameters for component {i + 1}."
                        )
