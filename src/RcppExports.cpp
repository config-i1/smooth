...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(matrixPowerWrap(matA, power));
    return __result;
END_RCPP
}
// polyMultwrap
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(polyMultwrap(polyVec1, polyVec2));
    return __result;
END_RCPP
}
// initparams
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(etsmatrices(matvt, vecg, phi, Cvalues, ncomponentsR, modellags, fittertype, Ttype, Stype, nexovars, matat, estimpersistence, estimphi, estiminit, estiminitseason, estimxreg, matFX, vecgX, gowild, estimFX, estimgX, estiminitX));
    return __result;
END_RCPP
}
// polysoswrap
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< SEXP >::type estimgX(estimgXSEXP);
    Rcpp::traits::input_parameter< SEXP >::type estiminitX(estiminitXSEXP);
    __result = Rcpp::wrap(polysoswrap(ARorders, MAorders, Iorders, ARIMAlags, nComp, AR, MA, constant, Cvalues, matvt, vecg, matF, fittertype, nexovars, matat, matFX, vecgX, estimAR, estimMA, requireConst, estimConst, estimxreg, gowild, estimFX, estimgX, estiminitX));
    return __result;
END_RCPP
}
// fitterwrap
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< SEXP >::type Stype(StypeSEXP);
    Rcpp::traits::input_parameter< SEXP >::type modellags(modellagsSEXP);
    __result = Rcpp::wrap(simulatorwrap(arrvt, materrors, matot, matF, matw, matg, Etype, Ttype, Stype, modellags));
    return __result;
END_RCPP
}
