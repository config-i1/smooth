...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool const& >::type adam(adamSEXP);
    rcpp_result_gen = Rcpp::wrap(adamFitterWrap(matrixVt, matrixWt, matrixF, vectorG, lags, indexLookupTable, profilesRecent, Etype, Ttype, Stype, componentsNumberETS, nSeasonal, nArima, nXreg, constant, vectorYt, vectorOt, backcast, nIterations, refineHead, adam));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool const& >::type constant(constantSEXP);
    Rcpp::traits::input_parameter< bool const& >::type adam(adamSEXP);
    rcpp_result_gen = Rcpp::wrap(adamSimulatorWrap(arrayVt, matrixErrors, matrixOt, arrayF, matrixWt, matrixG, E, T, S, lags, indexLookupTable, profilesRecent, nSeasonal, componentsNumber, nArima, nXreg, constant, adam));
    return rcpp_result_gen;
END_RCPP
}
// matrixPowerWrap
