...
test_that("Check exogenous variables for GES on N1457", {
    expect_equal(suppressWarnings(round(ges(y, h=18, holdout=TRUE, xreg=x, silent=TRUE)$forecast[1],3)), 5755.669);
    expect_equal(suppressWarnings(round(forecast(testModel, h=18, holdout=FALSE)$forecast[18],3)), 2645.793);
})
