...
adamFitterWrap <- function(matVt, matWt, matF, vecG, lagsModelAll, profilesObservedTable, profilesRecentTable, Etype, Ttype, Stype, componentsNumberETS, nSeasonal, nArima, nXreg, constant, yInSample, ot, backcast) {
    .Call('_smooth_adamFitterWrap', PACKAGE = 'smooth', matVt, matWt, matF, vecG, lagsModelAll, profilesObservedTable, profilesRecentTable, Etype, Ttype, Stype, componentsNumberETS, nSeasonal, nArima, nXreg, constant, yInSample, ot, backcast)
}
...
adamErrorerWrap <- function(matVt, matWt, matF, lagsModelAll, profilesObservedTable, profilesRecentTable, Etype, Ttype, Stype, componentsNumberETS, nSeasonal, nArima, nXreg, constant, horizon, yInSample, ot) {
    .Call('_smooth_adamErrorerWrap', PACKAGE = 'smooth', matVt, matWt, matF, lagsModelAll, profilesObservedTable, profilesRecentTable, Etype, Ttype, Stype, componentsNumberETS, nSeasonal, nArima, nXreg, constant, horizon, yInSample, ot)
}
