...
smoothEigensCpp <- function(persistence, transition, measurement, lagsModelAll, xregModel, obsInSample, hasDelta) {
    .Call('_smooth_smoothEigensCpp', PACKAGE = 'smooth', persistence, transition, measurement, lagsModelAll, xregModel, obsInSample, hasDelta)
}
