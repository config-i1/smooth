...
cesfitterwrap <- function(matvt, matF, matw, yt, vecg, Stype, seasfreq, matwex, matxtreg) {
    .Call('smooth_cesfitterwrap', PACKAGE = 'smooth', matvt, matF, matw, yt, vecg, Stype, seasfreq, matwex, matxtreg)
}

cesforecasterwrap <- function(matvt, matF, matw, h, Stype, seasfreq, matwex, matxtreg) {
    .Call('smooth_cesforecasterwrap', PACKAGE = 'smooth', matvt, matF, matw, h, Stype, seasfreq, matwex, matxtreg)
}

ceserrorerwrap <- function(matvt, matF, matw, yt, h, Stype, seasfreq, matwex, matxtreg) {
    .Call('smooth_ceserrorerwrap', PACKAGE = 'smooth', matvt, matF, matw, yt, h, Stype, seasfreq, matwex, matxtreg)
}

cesoptimizerwrap <- function(matvt, matF, matw, yt, vecg, h, Stype, seasfreq, multisteps, CFt, normalizer, matwex, matxtreg) {
