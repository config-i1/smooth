...
smoothEigensR <- function(persistence, transition, measurement, lagsModelAll, xregModel, obsInSample, hasDelta) {
    .Call('_smooth_smoothEigensR', PACKAGE = 'smooth', persistence, transition, measurement, lagsModelAll, xregModel, obsInSample, hasDelta)
}
