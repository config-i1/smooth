.onAttach <- function(libname, pkgname) {
    ...
    if(randomNumber<=4){
      ...
      if(randomNumber==1){
        startUpMessage <- paste0(startUpMessage,"By the way, have you already tried adam() function from smooth?");
      }
      else if(randomNumber==2){
        startUpMessage <- paste0(startUpMessage,"If you want to know more about the smooth package and forecasting, ",
                                 "you can visit my website: https://forecasting.svetunkov.ru/");
      }
      else if(randomNumber==3){
        startUpMessage <- paste0(startUpMessage,"Have you tried adam() yet? If you want to know more about this function, ",
                                 "you can visit my online textbook: https://www.openforecast.org/adam/");
      }
      else if(randomNumber==4){
        startUpMessage <- paste0(startUpMessage,"Any thought or suggestions about the package? ",
